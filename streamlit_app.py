...
for nameChr, name in enumerate(var_names):
	...
	try:
		...
		st.error("Die Formel enthält Abschnitte die entweder rein formativ sind, falsch geschrieben wurden oder nicht/falsch als Variable in der Tabelle maskiert wurden. Überprüfe Formel und Variablen nocheinmal.", icon="🚨")
